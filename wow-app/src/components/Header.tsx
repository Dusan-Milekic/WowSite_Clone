...
import { toggleGameInfo, toggleExpansionInfo, toggleCommunityInfo, toggleShopInfo } from "./HeaderFunctions.ts"
...
export default function Header() {
    ...
    //shop refs
    const shopInfo = createRef<HTMLDivElement>();
    const listShopInfo = createRef<HTMLLIElement>();
    const arrowShopInfo = createRef<SVGSVGElement>();

    //states for dropdown menus
    const [shopInfoState, setShopInfoState] = useState(false);
    ...
    const openNavigation = () => {
        if (navigation.current && !navState) {
    ...
    window.addEventListener("click", (e) => {
        if (navigation.current) {
            if (e.x > navigation.current.offsetWidth) {
                closeNavigation();
    ...
    return (
        <header className="flex  items-center justify-between h-14 bg-[#3b2a29cc] text-white  md:h-[72px] md:mx-4 md:mt-4 md:rounded-lg">
            <div className="left flex  items-center gap-3">
                    ...
                    <div className="absolute bg-[#2e1e1e]  h-full overflow-y-scroll min-w-[360px] top-0 left-0  space-y-5 text-white hidden" ref={navigation} id="navigation">
                        ...
                        <ul className="space-y-5 ">
                            ...
                            <li className="px-4 mx-2 rounded-lg" ref={listCommunityInfo}>
                                <div className="info  flex items-center cursor-pointer" onClick={() => toggleCommunityInfo(communityInfo, listCommunityInfo, arrowCommunityInfo, communityInfoState, setCommunityInfoState)}>
                                    <p className="text-lg font-bold ">Community</p>
                                    <svg xmlns="http://www.w3.org/2000/svg" ref={arrowCommunityInfo} className="ml-1 w-3.5" fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg>
                                </div>
                                <div className="font-bold mt-2 hidden" ref={communityInfo} style={{ display: communityInfoState ? "block" : "none" }}>
                                    <ul className="space-y-4 py-3">
                            ...
                            <li className="px-4 mx-2 rounded-lg " ref={listShopInfo}>
                                <div className="info  flex items-center hover:cursor-pointer" onClick={() => toggleShopInfo(shopInfo, listShopInfo, arrowShopInfo, shopInfoState, setShopInfoState)}>
                                    <p className="text-lg font-bold ">Shop</p>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 w-3.5" ref={arrowShopInfo} fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true"><path d="m6 9 6 6 6-6"></path></svg>
                                </div>

                                <div className="font-bold mt-2 hidden" ref={shopInfo} style={{ display: shopInfoState ? "block" : "none" }}>
                                    <ul className="space-y-6 py-3">
                                        <li className="hover:opacity-50 hover:cursor-pointer flex space-x-3">
                                            <div className="w-12">
                                                <img src="https://blz-contentstack-images.akamaized.net/v3/assets/blt72f16e066f85e164/blta76b5a8706ea4c77/63f51ab34c740e6b39ed8137/in-game_content.png" alt=""></img>
                                            </div>
                                            <div>
                                                <p>In-Game Content</p>
                                                <p className="opacity-50 font-medium text-sm">Mounts, Pets, Services, ...</p>
                                            </div>

                                        </li>
                                        <li className="hover:opacity-50 hover:cursor-pointer"><p>Gear</p></li>
                ...
                {/* Logo */}
                <div className="hidden logo pl-2 md:flex md:items-center">
                    ...
                    <div className="info hidden md:flex md:items-center relative group hover:cursor-pointer">
                        <p className="text-lg font-bold ml-5">Game Info</p>
                        <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 w-3.5" fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="m6 9 6 6 6-6"></path>
                        </svg>
                        <div className="font-bold absolute top-14 -left-24 bg-[#3b2a29cc] rounded-lg w-80 hidden group-hover:block before:content-[''] before:absolute before:bottom-full before:left-0 before:right-0 before:h-14">
                            <ul className="space-y-4 py-3 px-5">
                                <li className="hover:opacity-50 hover:cursor-pointer"><p>Overview</p></li>
                                <li className="hover:opacity-50 hover:cursor-pointer"><p>Races</p></li>
                                <li className="hover:opacity-50 hover:cursor-pointer"><p>Classess</p></li>
                                <li className="hover:opacity-50 hover:cursor-pointer"><p>Returning players</p></li>
                            ...
                            <div className="bg-[rgb(27,20,20)] py-4">
                                <p className="my-3 opacity-50 text-sm px-5">LORE</p>
                                <ul className="space-y-4 py-3 px-5">
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Story & Media</p></li>
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Warcraft Timeline</p></li>
                                </ul>
                    ...
                    {/* Expansions */}
                    <div className="info hidden lg:flex lg:items-center lg:ml-5 relative group hover:cursor-pointer">
                        <p className="text-lg font-bold ml-5">Expansions</p>
                        <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 w-3.5" fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="m6 9 6 6 6-6"></path>
                        </svg>
                        <div className="font-bold absolute top-14 -left-24 bg-[#3b2a29cc] rounded-lg w-80 hidden group-hover:block before:content-[''] before:absolute before:bottom-full before:left-0 before:right-0 before:h-14">
                            ...
                            <div className="bg-[rgb(27,20,20)] py-4">
                                <p className="my-3 opacity-50 text-sm px-5">WOW CLASSIC</p>
                                <ul className="space-y-4 py-3 px-5">
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Mists of Pandaria</p></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    {/*NEWS */}
                    <div className="info hidden 2lg:flex 2lg:items-center  2lg:ml-5">
                        <p className="text-lg font-bold ml-5">News</p>
                    </div>
                    {/*Community */}
                    <div className="info hidden xl:flex xl:items-center xl:ml-5 relative group hover:cursor-pointer">
                        <p className="text-lg font-bold ml-5">Community</p>
                        <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 w-3.5" fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="m6 9 6 6 6-6"></path>
                        </svg>
                        <div className="font-bold absolute top-14 -left-24 bg-[#3b2a29cc] rounded-lg w-80 hidden group-hover:block before:content-[''] before:absolute before:bottom-full before:left-0 before:right-0 before:h-14">
                            ...
                            <div className="py-4">
                                <p className="my-3 opacity-50 text-sm px-5">LEADERBOARDS</p>
                                <ul className="space-y-4 py-3 px-5">
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Mythic Dungeon</p></li>
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Mythic Raid</p></li>
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Player vs. Player</p></li>
                            ...
                            <div className="bg-[rgb(27,20,20)] py-4">
                                <p className="my-3 opacity-50 text-sm px-5">ESPORTS</p>
                                <ul className="space-y-4 py-3 px-5">
                                    <li className="hover:opacity-50 hover:cursor-pointer"><p>Tournaments</p></li>
                                </ul>
                            </div>
                    ...
                    {/* Shop */}
                    <div className="info hidden 2xl:flex 2xl:items-center 2xl:ml-5 relative group hover:cursor-pointer">
                        <p className="text-lg font-bold ml-5">Shop</p>
                        <svg xmlns="http://www.w3.org/2000/svg" className="ml-1 w-3.5" fill="none" stroke="grey" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="m6 9 6 6 6-6"></path>
                        </svg>
                        <div className="font-bold absolute top-14 -left-24 bg-[#3b2a29cc] rounded-lg w-80 hidden group-hover:block before:content-[''] before:absolute before:bottom-full before:left-0 before:right-0 before:h-14">
                            <ul className="space-y-6 py-3 px-5">
                                <li className="hover:opacity-50 hover:cursor-pointer flex space-x-3">
                                    <div className="w-12">
                                        <img src="https://blz-contentstack-images.akamaized.net/v3/assets/blt72f16e066f85e164/blta76b5a8706ea4c77/63f51ab34c740e6b39ed8137/in-game_content.png" alt="In-Game Content"></img>
                                    </div>
                                    <div>
                                        <p>In-Game Content</p>
                                        <p className="opacity-50 font-medium text-sm">Mounts, Pets, Services, ...</p>
                    ...
                    {/* Three dots menu */}
                    <div className="ml-3 hidden md:block  cursor-pointer bg-[#ffffff0D] p-3 rounded-lg 2xl:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2m7 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2M5 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2"></path></svg>
                    </div>
            ...
            <div className="right flex items-center px-4 gap-2.5">
                {/* User icon */}
                <div className="m-2 p-2 flex items-center gap-4  cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0"></path></svg>
                ...
                <div className="bg-[#060C11] rounded-lg hidden md:block"><p className="px-3 pb-4 pt-3 font-bold">Try free</p></div>
